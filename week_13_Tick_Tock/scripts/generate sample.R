...
# rm(base_name, base_names, base_times, base_time, base_date, base_dates, n)


base_time_out <- "017:00:00"
base_times_out <- rep(base_time, n)

df <- cbind(df, base_dates, base_times)
